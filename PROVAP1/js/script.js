...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("enderecodatia").value = cliente.enderecodatia
...
function salvar(){
    ...
    let enderecodatia = document.getElementById("enderecodatia").value
    ...
    if (clienteAlterado == null){
        ...
        clienteAlterado.telefone2 = telefone2
        clienteAlterado.enderecodatia = enderecodatia
    }
...
function exibirDados(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        <tr>
            ...
            <td>${clientes[i].telefone2}</td>
            <td>${clientes[i].enderecodatia}</td>
            <td>
...
function limparForm(){
    ...
    document.getElementById("enderecodatia").value = ""
}